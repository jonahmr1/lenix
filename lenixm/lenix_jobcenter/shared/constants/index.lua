...
constants.styleConfig = {
  ui = {
    title = "Public Job Center",
    subtitle = "Find your next opportunity",
    maxWidth = "1200px",
    maxHeight = "80vh",
    -- Converted array to indexed table for consistency
    coords = { -1083.17, -245.77, 37.76, 204.31 } 
  },
  theme = {
    primary = "80, 128, 118",
    secondary = "132, 96, 58",
...
constants.jobsConfig = {
  garbage = {
    ...
    icon = "fas fa-trash",
    enabled = true,
    -- Lua tables can use integers as keys directly
    repGrades = {
      [0] = 1,
      [1] = 10,
      [2] = 20,
