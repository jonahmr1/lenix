...
### Instructions
* Installation: configure your API's [client api](./client/api/index.ts) and [server api](./server/api/index.ts)
...
* type: `string` The type of rep
  ...
  * low
  * lowend
  check shared/constants/index.ts for more info
...
const jobsConfig = {
  job: { /**@field jobName same as in the core/shared*/
      ...
      repGrades: { /**@field object the levels of each grade*/ 
