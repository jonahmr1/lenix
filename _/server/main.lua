...
lib.callback.register('lenix_bossdesk:server:getJobPlayersData', function()
  ...
  for i = 1, #player do
    ...
    players[i] = {
      ...
      rank = playerGrade,
      callsign = playersDataB.PlayerData.metadata.callsign or "NO CALLSIGN",
...
lib.callback.register('lenix_bossdesk:server:hirePlayer', function(_, citizenid, grade, callsign)
  ...
  core:SetMetadata(citizenid, 'callsign', callsign)
  if hasPoliceJob(getPlayerSourceByCitizenId(citizenid)) then
