...
local function isPlayerAllowed(processedItem)
  ...
  local inAllowList = tr_lib.triggerPromise('isPlayerInAllowList', allowedTargets)
  local notInDisallowList = tr_lib.triggerPromise('isPlayerNotInDisallowedList', disallowedTargets)
