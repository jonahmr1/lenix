return {
    framework = "ox", -- Framework for player stats: "none", "esx", "qb", "ox", "custom".
    speedUnit = "kph", -- Speed unit: "mph" or "kph".

    useBuiltInSeatbeltLogic = true, -- Enable custom seatbelt logic (true/false).
    ejectMinSpeed = 500.0, -- Using built-in seatbelt logic: Minimum speed to eject when not wearing a seatbelt (in speedUnit).
