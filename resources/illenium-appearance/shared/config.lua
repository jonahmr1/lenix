...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(475.1736, -1009.5829, 30.7110, 31.7107),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(470.0151, -1001.3965, 30.7109),
            vector3(470.1297, -1009.6039, 30.7109),
            vector3(481.0208, -1009.4929, 30.7109),
            vector3(481.3802, -1001.0052, 30.7109),
        }
    }
}
