  ...
  peds = {
    {
      ...
      Coords = vec4(-2213.64, -371.48, 13.32, 39.33),
    },
    {
      model = 'g_m_m_armboss_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(1075.89, -2358.9, 30.28, 261.78),
    },
    {
      model = 'g_m_y_ballaeast_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(545.97, -2690.91, 6.22, 3.52),
    },
    {
      model = 'g_m_y_ballaorig_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(1459.76, 1043.43, 112.33, 272.81),
    },
    {
      model = 'g_m_y_ballasout_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(-1844.91, 223.29, 84.44, 308.06),
    },
    {
      model = 'g_m_y_lost_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(793.74, 537.9, 126.11, 142.59),
    },
    {
      model = 'g_m_y_mexgoon_03',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(1661.04, -26.0, 17377, 116.52),
    },
    {
      model = 'g_m_y_salvaboss_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(-957.23, -1566.86, 5.02, 106.8),
    },
    {
      model = 'g_m_y_mexgoon_02',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(164.83, 2226.22, 90.87, 51.62),
    },
    {
      model = 'g_m_y_armgoon_02',
      scenario = 'WORLD_HUMAN_STAND_FISHING',
      Coords = vec4(713.28, 4092.59, 35.73, 179.51),
    },
    {
      model = 'g_m_y_korean_02',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(-2165.67, 5196.09, 16.88, 58.42),
    },
    {
      model = 'g_m_m_chicold_01',
      scenario = 'WORLD_HUMAN_LEANING',
      Coords = vec4(445.96, 6463.31, 28.78, 54.34),
    },
  },
}