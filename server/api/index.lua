...
tr_lib.onPromise('sessionStatus', function() 
  return services.isPreviewSessionBusy() 
end)

tr_lib.onPromise('isPlayerInAllowList', function(source, allowedList)
  return services.isPlayerBelongToPositions(source, allowedList)
end)

tr_lib.onPromise('isPlayerNotInDisallowedList', function(source, disallowedList)
